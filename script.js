const question = document.getElementById('question');
        ...
        beforeBtn.addEventListener('click', () => {
            ...
            if (start <= end) {
                ...
                result.textContent = `I couldn't guess your birthday. Please try again.`;
                gameOver();
            }
        });

        onBtn.addEventListener('click', () => {
            result.textContent = `I guessed your birthday in ${guessCount} tries! It's ${dateFromDayOfYear(mid)}.`;
            gameOver();
        });
